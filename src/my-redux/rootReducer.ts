...
export const rootReducer = (
  ...
  switch (action.type) {
    ...
    case CHANGE_NAME_TEAM:
      // console.log("do: "+new_state.namesTeams[action.payload.indexMatch][action.payload.indexTeam]);
      new_state.namesTeams[action.payload.indexMatch][action.payload.indexTeam] = action.payload.value;
      // console.log("pos: "+new_state.namesTeams[action.payload.indexMatch][action.payload.indexTeam]);
      // new_state.namesTeams.push(["wegerg"]);
      return new_state;
    /**Редактирование приоритетов */
    case CHANGE_PRIORITY:
      new_state.scoresPriorities[action.payload.indexMatch][action.payload.indexPriority] = action.payload.value;
      return new_state;
